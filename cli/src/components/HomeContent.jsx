...
export const HomeContent = () => {
  return (
    <div className='context'>
        ...
        <p className='context__p'> WE at <span className='context__span context__logo'>GAD</span><span className=' context__o'>o</span> work hard to make sure you have the most simplified and haggle-free experience when buying or selling goods. </p>
    </div>
  )
}
